...
func GetSeckillList(ctx *gin.Context) {
	...
	seckill_service := product_srv.NewSecKillsService("xlf.product.srv.product_srv", service.Client())

	rep, err := seckill_service.SecKillList(context.TODO(), &product_srv.SecKillsRequest{
...
func GetProducts(ctx *gin.Context) {
	...
	rep, err := seckill_service.GetProducts(context.TODO(), &product_srv.ProductRequest{})
...
func SecKillAdd(ctx *gin.Context) {
	...
	rep, _ := seckill_service.SecKillAdd(context.TODO(), &product_srv.SecKill{
		Name:      name,
...
func SecKillDel(ctx *gin.Context) {
	...
	rep, _ := seckill_service.SecKillDel(context.TODO(), &product_srv.SecKillDelRequest{
...
func SeckillToEdit(ctx *gin.Context) {
	...
	seckill_service := product_srv.NewSecKillsService("xlf.product.srv.product_srv", service.Client())
	rep, err := seckill_service.SecKillToEdit(context.TODO(), &product_srv.SecKillDelRequest{
		Id: utils.StrToInt(id),
	})
...
func ProductDoEdit(ctx *gin.Context) {
	...
	rep, _ := seckill_service.SecKillDoEdit(context.TODO(), &product_srv.SecKill{
		Id:        utils.StrToInt(id),
		Name:      name,
		Num:       utils.StrToInt(num),
		Price:     utils.StrToFloat32(price),
...
func GetFrontSeckillList(ctx *gin.Context) {
	...
	seckill_service := product_srv.NewSecKillsService("xlf.product.srv.product_srv", service.Client())
	rep, err := seckill_service.FrontSecKillList(context.TODO(), &product_srv.FrontSecKillRequest{
		CurrentPage: utils.StrToInt(currentPage),
		Pagesize:    utils.StrToInt(pageSize),
	})
...
func SecKillDetail(ctx *gin.Context) {
	...
	seckill_service := product_srv.NewSecKillsService("xlf.product.srv.product_srv", service.Client())
	rep, err := seckill_service.FrontSecKillDetail(context.TODO(), &product_srv.SecKillDelRequest{
		Id: utils.StrToInt(id),
	})
