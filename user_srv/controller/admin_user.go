...
func (a *AdminUser) AdminUserLogin(ctx context.Context, in *user_srv.AdminUserRequest, out *user_srv.AdminUserRespond) error {
...
func (a *AdminUser) FrontUserList(ctx context.Context, in *user_srv.FrontUsersRequest, out *user_srv.FrontUsersRespond) error {
